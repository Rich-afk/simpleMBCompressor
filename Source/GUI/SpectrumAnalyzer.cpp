...
{
    //==============================================================================
    SpectrumAnalyzer::SpectrumAnalyzer(juce::AudioProcessor &processor, SCSF &leftChannelFifo, SCSF &rightChannelFifo) : sampleRate(processor.getSampleRate()),
    ...
    MBCompAnalyzerOverlay::MBCompAnalyzerOverlay(juce::AudioParameterFloat &lowXover,
                                                 ...
                                                 juce::AudioParameterFloat &highThresh) : lowMidXoverParam(&lowXover),
